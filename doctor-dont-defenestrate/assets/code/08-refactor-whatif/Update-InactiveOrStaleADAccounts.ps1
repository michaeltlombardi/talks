<#
  ...
  .EXAMPLE
    .\Update-InactiveOrStaleADAccounts.ps1 -WhatIf

    This executes the script in WhatIf mode, so no accounts will be
    disabled or deleted. It will return the list of accounts that would
    be disabled/deleted to the console as well as the paths to CSV files
